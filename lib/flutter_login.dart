...
import 'package:k_login/src/models/login_user_type.dart';
import 'package:k_login/src/models/term_of_service.dart';
import 'package:k_login/src/models/user_form_field.dart';
import 'package:k_login/src/providers/auth.dart';
import 'package:k_login/src/providers/login_messages.dart';
import 'package:k_login/src/providers/login_theme.dart';
import 'package:k_login/src/utils/color_helper.dart';
import 'package:k_login/src/utils/constants.dart';
import 'package:k_login/src/utils/dart_helper.dart';
import 'package:k_login/src/widgets/cards/auth_card_builder.dart';
import 'package:k_login/src/widgets/fade_in.dart';
import 'package:k_login/src/widgets/gradient_box.dart';
import 'package:k_login/src/widgets/hero_text.dart';
import 'package:k_login/theme.dart';
...
class FlutterLogin extends StatefulWidget {
  FlutterLogin({
    ...
    this.loginAfterSignUp = true, // 设置为 false 则注册成功后返回登录页面
    this.footer,
